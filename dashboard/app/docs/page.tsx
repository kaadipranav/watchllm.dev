  ...
  const categories = [
    {
      ...
      items: [
        {
          title: "Quick Start",
          description: "Get up and running with semantic caching in minutes.",
        ...
        {
          title: "Deployment",
          description: "Step-by-step guide to deploying your own instance.",
        ...
        {
          title: "Cheat Sheet",
          description: "Quick reference for SDKs, headers, and commands.",
    ...
    },
    {
      ...
      items: [
        {
          title: "Architecture",
          description: "Deep dive into the edge-proxy system design.",
        ...
        },
        {
          ...
          description: "Learn how to interpret your cost savings and performance.",
        ...
        {
          title: "Code Examples",
          description: "Ready-to-use snippets for JS, Python, and cURL.",
          href: "/docs/EXAMPLES",
          icon: Code,
          color: "text-cyan-400",
    ...
    },
    {
      ...
      items: [
        {
          title: "API Reference",
          description: "Complete endpoint documentation and parameters.",
          href: "/docs/API",
          icon: Terminal,
          color: "text-pink-400",
        ...
        },
        {
          ...
          description: "Advanced debugging and connectivity fixes.",
