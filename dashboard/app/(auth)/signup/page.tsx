...
function SignupForm() {
  ...
  return (
    <div className="space-y-4">
      {APP_CONFIG.isBeta && (
        <div className="rounded-lg border border-blue-500/20 bg-blue-500/5 p-4 text-blue-400">
          <div className="flex items-center gap-3">
            <AlertCircle className="h-5 w-5 shrink-0" />
            <div className="text-sm font-medium">
              WatchLLM is currently in Beta / Testing
            </div>
          </div>
          <p className="mt-1.5 ml-8 text-xs text-blue-400/70">
            Some features may be experimental. Billing is currently disabled.
          </p>
        </div>
      )}
      <Card>
