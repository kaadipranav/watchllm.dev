    ...
    <div className="min-h-screen bg-[hsl(222_47%_4%)] text-premium-text-primary px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-4 text-premium-text-secondary leading-relaxed text-sm sm:text-base">
            ...
            <div id="toc">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li><button onClick={() => scrollToSection('services')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">OUR SERVICES</button></li>
                <li><button onClick={() => scrollToSection('ip-rights')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">INTELLECTUAL PROPERTY RIGHTS</button></li>
                <li><button onClick={() => scrollToSection('user-representations')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">USER REPRESENTATIONS</button></li>
                <li><button onClick={() => scrollToSection('prohibited')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">PROHIBITED ACTIVITIES</button></li>
                <li><button onClick={() => scrollToSection('user-contributions')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">USER GENERATED CONTRIBUTIONS</button></li>
                <li><button onClick={() => scrollToSection('contribution-license')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">CONTRIBUTION LICENSE</button></li>
                <li><button onClick={() => scrollToSection('services-management')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">SERVICES MANAGEMENT</button></li>
                <li><button onClick={() => scrollToSection('term-termination')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">TERM AND TERMINATION</button></li>
                <li><button onClick={() => scrollToSection('modifications')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">MODIFICATIONS AND INTERRUPTIONS</button></li>
                <li><button onClick={() => scrollToSection('governing-law')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">GOVERNING LAW</button></li>
                <li><button onClick={() => scrollToSection('dispute-resolution')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">DISPUTE RESOLUTION</button></li>
                <li><button onClick={() => scrollToSection('corrections')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">CORRECTIONS</button></li>
                <li><button onClick={() => scrollToSection('disclaimer')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">DISCLAIMER</button></li>
                <li><button onClick={() => scrollToSection('liability-limitations')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">LIMITATIONS OF LIABILITY</button></li>
                <li><button onClick={() => scrollToSection('indemnification')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">INDEMNIFICATION</button></li>
                <li><button onClick={() => scrollToSection('user-data')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">USER DATA</button></li>
                <li><button onClick={() => scrollToSection('electronic-communications')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</button></li>
                <li><button onClick={() => scrollToSection('miscellaneous')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">MISCELLANEOUS</button></li>
                <li><button onClick={() => scrollToSection('contact-us')} className="text-blue-400 hover:text-blue-300 underline cursor-pointer">CONTACT US</button></li>
              </ol>
            </div>

            <div id="services">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">1. OUR SERVICES</h2>
              <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
            </div>

            <div id="ip-rights">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">2. INTELLECTUAL PROPERTY RIGHTS</h2>
              <h3 className="text-white text-xl font-semibold mb-4">Our intellectual property</h3>
              ...
              <h3 className="text-white text-xl font-semibold mb-4">Your use of our Services</h3>
              ...
              <h3 className="text-white text-xl font-semibold mb-4">Your submissions</h3>
            ...
            <div id="user-representations">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">3. USER REPRESENTATIONS</h2>
            ...
            <div id="prohibited">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">4. PROHIBITED ACTIVITIES</h2>
            ...
            <div id="user-contributions">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">5. USER GENERATED CONTRIBUTIONS</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>You are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, the Services, and other users of the Services to use your Contributions in any and all manners contemplated by the Services and these Legal Terms.</li>
                ...
                <li>Your Contributions do not threaten (in the legal sense of those terms) any other person and to promote violence against a specific person or class of people.</li>
            ...
            <div id="contribution-license">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">6. CONTRIBUTION LICENSE</h2>
            ...
            <div id="services-management">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">7. SERVICES MANAGEMENT</h2>
            ...
            <div id="term-termination">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">8. TERM AND TERMINATION</h2>
            ...
            <div id="modifications">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">9. MODIFICATIONS AND INTERRUPTIONS</h2>
            ...
            <div id="governing-law">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">10. GOVERNING LAW</h2>
              <p>These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of India applicable to agreements made and to be entirely performed within India, without regard to its conflict of law principles.</p>
            </div>
            ...
            <div id="indemnification">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">15. INDEMNIFICATION</h2>
            ...
            <div id="user-data">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">16. USER DATA</h2>
            ...
            <div id="electronic-communications">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
            ...
            <div id="miscellaneous">
              <h2 className="text-white text-2xl font-semibold mb-6 mt-10 border-b border-white/20 pb-2">18. MISCELLANEOUS</h2>
        ...
        {showBackToTop && (
          <button
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors"
